...
class ExpensesTotalStatement(ReportView):
    ...
    chart_settings = [
        {"data_source": ["__total__"], "type": "pie", "title_source": ["name"]},
        {"data_source": ["__total__"], "type": "column", "title_source": ["name"]},
    ]
    doc_type_field_name = "type"
...
class ExpenseMovementDaily(ReportView):
    ...
    def get_form_initial():
        ...
        return {"start_date": now() - datetime.timedelta(days=14), "end_date": now()}
